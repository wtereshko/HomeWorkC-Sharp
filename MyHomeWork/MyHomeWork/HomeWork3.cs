...
{
    /*1) Read the text as a string value and calculate the counts of characters 'a', 'o', 'i', 'e' in this text.
      2) Ask user to enter the number of month. Read the value and write the amount of days in this month.
