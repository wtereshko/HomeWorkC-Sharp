   ...
   public class HomeWork1
    {
        ...
        /*1) define integer variable a. Read the value of a from console and calculate area
        ...
        /*3) Read double number r and calculate the length(l= 2 * pi * r), area(S= pi * r * r) and
            volume(4/3*pi* r*r* r) of a circle of given r*/
